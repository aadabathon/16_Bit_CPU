...
REM
REM Generated by Vivado on Wed Aug 19 15:55:09 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_cpu16_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_cpu16_vlog.prj -log xvlog.log
